...
function dibujaOvni(){
    ...
    if(nivel.muerto==false){
        ctx.drawImage(imgOvni,0,0,920,936,tovni.x,tovni.y,100,80)
    }else{
        ctx.drawImage(imgOvniMuerto,0,0,920,936,tovni.x,tovni.y,100,80) }
...
function puntuacion(){
    ...
    if(nivel.muerto==true){
        ...
        ctx.fillText("MARIO EN MARTE",170,250);
