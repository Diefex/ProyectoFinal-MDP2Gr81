...
function dibujaOvni(){
    ...
    if(nivel.muerto==false){
        ctx.drawImage(imgOvni,0,0,512,512,tovni.x,tovni.y,100,80)
    }else{
        ctx.drawImage(imgOvniMuerto,0,0,512,512,tovni.x,tovni.y,100,80) }
...
function puntuacion(){
    ...
    if(nivel.muerto==true){
        ...
        ctx.fillStyle="white"
        ctx.fillText("VIAJE ESPACIAL",170,250);
